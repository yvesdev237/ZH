    ...
    <main className="min-h-screen w-full p-2 flex flex-col pb-20">
      ...
      <section className=" w-full p-2 flex flex-col justify-center items-center gap-4">
        <div className="relative w-[90%] flex flex-col justify-center items-center gap-2 rounded-2xl shadow-lg p-4">
          <div className="relative w-24 h-24 bg-gray-300 rounded-full flex items-center justify-center">
            ...
            <FaPencil className="absolute bottom-0 right-2 text-white bg-blue-500 rounded-full p-2 size-8" />
          </div>
      ...
      <section className="w-full p-2 flex flex-col justify-center items-start gap-4">
        ...
        <div className="w-full flex flex-col justify-center items-start text-lg">
          <button className="flex items-start gap-4 w-full p-2 ">
          ...
          <div className="inset-0 z-50 h-full bg-black/50 absolute flex justify-center items-center" style={{ display: isLoading ? 'flex' : 'none' }}>
            <TailSpin />
          </div>
          <div className="flex justify-center items-start gap-4"></div>
        </div>
      </section>
    </main>
  );
